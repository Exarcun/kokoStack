...
import { View, StyleSheet, TouchableOpacity, Dimensions, Text, StatusBar } from 'react-native';
...
import ChatScreen from '../(tabs)/ChatScreen/ChatScreen'; // Import your existing ChatScreen
