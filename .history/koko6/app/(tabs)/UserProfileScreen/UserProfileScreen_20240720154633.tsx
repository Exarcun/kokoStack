...
import { View, Text, Image, ScrollView, TouchableOpacity, ActivityIndicator, SafeAreaView, Animated } from 'react-native';
    ...
    const fetchUserData = async () => {
      ...
      try {
        const [profileResponse, postsResponse] = await Promise.all([
          axios.get(`http://172.20.0.119:5000/api/user/${route.params.email}`),
          axios.get(`http://172.20.0.119:5000/api/user/${route.params.email}/posts`)
        ]);
          ...
          <Image
            source={
              userProfile.profilepic
                ? { uri: `http://172.20.0.119:5000/${userProfile.profilepic}` }
